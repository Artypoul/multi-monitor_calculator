...
description: Чеклист affordance-matrix и form save scope из AGENTS.md перед/после рефакторинга форм, split секций, списков, стриминга. Отчёт P0–P2; правки только по запросу.
...
Источник: **`AGENTS.md`** — разделы **Affordance-matrix** и **Form save scope**.
