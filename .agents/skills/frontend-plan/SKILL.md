---
name: frontend-plan
description: План фронтенд-задачи для repair calculator (SvelteKit/Vite/TS) до написания кода. Читает AGENTS.md, history.md (если есть) и git. Используй перед фичей, рефакторингом или «что делать дальше».
...
1. Прочитай **`AGENTS.md`** в корне — стек, PR workflow, responsive, history, affordance-matrix, form save scope.
