...
- Обнови **верх файла**: дата «Последнее обновление», TL;DR при необходимости, **строка таблицы PR** если это PR-релиз (см. CLAUDE.md).
- Отдельный мини-PR только на docs — допустим по CLAUDE.md (`docs(history.md): …`).
