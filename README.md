...
CTA "Оставить заявку" готовит карточку заявки на экране и проверяет имя/телефон. Реальная отправка заявки в ERP подключается отдельно, когда известен backend-контракт для создания заявки.
